...
public class BufferedBitReader {
	...
	int current;    // Current byte being returned, bit by bit, h
	int next;       // Next byte to be returned (could be a count), e
	int afterNext;  // Byte two after the current byte, l
